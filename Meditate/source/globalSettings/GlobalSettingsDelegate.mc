...
class GlobalSettingsDelegate {
	...
	function showGlobalSettingsMenu() {
		...
		menu.addItem(
			new Ui.MenuItem(Ui.loadResource(Rez.Strings.menuGlobalSettings_prepareTime), "", :prepareTime, {})
		);
		menu.addItem(
			new Ui.MenuItem(Ui.loadResource(Rez.Strings.menuGlobalSettings_finalizeTime), "", :finalizeTime, {})
		);
		menu.addItem(
		...
		menu.addItem(
			new Ui.MenuItem(Ui.loadResource(Rez.Strings.menuGlobalSettings_useSessionName), "", :useSessionName, {})
		);
		menu.addItem(
			new Ui.MenuItem(Ui.loadResource(Rez.Strings.menuGlobalSettings_newHrvTracking), "", :hrvTracking, {})
		);
		menu.addItem(new Ui.MenuItem(Ui.loadResource(Rez.Strings.menuHrvWindowSizeOptions_title), "", :hrvWindow, {}));
		menu.addItem(
			new Ui.MenuItem(Ui.loadResource(Rez.Strings.menuGlobalSettings_respirationRate), "", :respirationRate, {})
		);
		menu.addItem(
			new Ui.MenuItem(Ui.loadResource(Rez.Strings.menuGlobalSettings_multiSession), "", :multiSession, {})
		);
		menu.addItem(
			new Ui.MenuItem(Ui.loadResource(Rez.Strings.menuGlobalSettings_sensorRestart), "", :sensorRestart, {})
		);
